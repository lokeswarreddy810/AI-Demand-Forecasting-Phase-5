function QuarterlyTargetCard({ target }) {
  return (
    <div className="bg-white dark:bg-[#1e1e1e] rounded-xl shadow-md p-5 border-l-4 border-green-500">
...
export default QuarterlyTargetCard;