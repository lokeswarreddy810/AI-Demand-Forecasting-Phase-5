...
function Navbar() {
  ...
  return (
    <div className="sticky top-0 z-40 bg-white dark:bg-[#1e1e1e] border-b border-green-200 dark:border-gray-700 px-8 py-4 flex justify-between items-center shadow-sm">

      <div className="flex items-center gap-6">

        <div className="hidden xl:flex flex-col min-w-[320px]">
          <h1 className="text-lg xl:text-xl font-bold text-[#123f1f] dark:text-white whitespace-nowrap">
            AI Demand Forecasting Platform
            </h1>
            </div>

            <div className="w-[700px] xl:w-[900px]">
              <GlobalSearch />
            </div>
